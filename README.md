...
Same format without the `season` field. Aggregates all resolved shows.

JSON is minified. Sonarr reads the `tvdbId` field; `title` is for readability.
